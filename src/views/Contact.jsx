...
const Contact = () => {
  ...
  return (
    <div
      ...
      className={
        darkMode
          ? "bg-white-100 pt-20  md:h-screen"
          : "bg-gray-800 pt-20 text-white md:h-screen"
      }
    >
      <div className="max-w-7xl mx-auto px-4  sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center md:items-stretch flex-col md:flex-row pb-20">
